...
class FloorSelect(discord.ui.Select):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        view.floor = self.values # EXTRAÇÃO CORRETA DA LISTA ✅
        view.clear_items()
...
class SpotSelect(discord.ui.Select):
    ...
    async def callback(self, interaction: discord.Interaction):
        view: ClaimWizardView = self.view
        view.spot = self.values # EXTRAÇÃO CORRETA DA LISTA ✅
        view.clear_items()
...
class TicketSelect(discord.ui.Select):
    def __init__(self, map_type, floor, spot):
        ...
        allowed_tickets = spots_info.get("tickets") or [1-4] # CORRIGIDO SINTAXE ✅
        ticket_labels = {
            1: "1 Ticket (30m)",
            2: "2 Tickets (1h)",
            3: "3 Tickets (1h30)",
    ...
    async def callback(self, interaction: discord.Interaction):
        view: ClaimWizardView = self.view
        view.tickets = int(self.values) # EXTRAÇÃO E CONVERSÃO CORRETA DA LISTA ✅
        view.clear_items()
