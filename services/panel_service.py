...
from database.repositories.claim_repo import ClaimRepository # IMPORTANTE: Ajuste de acordo com seu import real
...
class PanelService:
    ...
    async def _update_single_panel(self, guild_id: int, map_type: str, target_channel: discord.TextChannel = None):
        ...
        embed = MIR4Embeds.build_panel_embed(map_type, claims)
